...
import yukiMini from "../assets/icon/Character/Yuki/mini.png";
...
import yukiHalf from "../assets/icon/Character/Yuki/Half.png";
...
const characterStats = {
  ...
  유키: {
    ...
    clutchRate: 0.26,
    stats: [
      { subject: "딜량", user: 82, avg: 60 },
      { subject: "KDA", user: 72, avg: 50 },
      { subject: "순위", user: 62, avg: 40 },
      { subject: "킬", user: 78, avg: 55 },
      { subject: "클러치", user: 68, avg: 45 },
    ],
  },
  레온: {
    nickname: "ERMaster",
    ...
    clutchRate: 0.17,
    stats: [
      { subject: "딜량", user: 68, avg: 60 },
      { subject: "KDA", user: 62, avg: 50 },
      { subject: "순위", user: 51, avg: 40 },
      { subject: "킬", user: 65, avg: 55 },
      { subject: "클러치", user: 52, avg: 45 },
    ],
  },
  아야: {
    nickname: "ERMaster",
    ...
    clutchRate: 0.3,
    stats: [
      { subject: "딜량", user: 87, avg: 60 },
      { subject: "KDA", user: 80, avg: 50 },
      { subject: "순위", user: 68, avg: 40 },
      { subject: "킬", user: 85, avg: 55 },
      { subject: "클러치", user: 75, avg: 45 },
    ],
  },
  실비아: {
    nickname: "ERMaster",
    ...
    clutchRate: 0.22,
    stats: [
      { subject: "딜량", user: 75, avg: 60 },
      { subject: "KDA", user: 67, avg: 50 },
      { subject: "순위", user: 56, avg: 40 },
      { subject: "킬", user: 73, avg: 55 },
  ...
  이솔: {
    ...
    clutchRate: 0.33,
    stats: [
      { subject: "딜량", user: 89, avg: 60 },
      { subject: "KDA", user: 83, avg: 50 },
      { subject: "순위", user: 72, avg: 40 },
      { subject: "킬", user: 90, avg: 55 },
      { subject: "클러치", user: 78, avg: 45 },
    ],
  },
  레녹스: {
    nickname: "ERMaster",
    ...
    clutchRate: 0.16,
    stats: [
      { subject: "딜량", user: 66, avg: 60 },
      { subject: "KDA", user: 60, avg: 50 },
      { subject: "순위", user: 50, avg: 40 },
      { subject: "킬", user: 62, avg: 55 },
      { subject: "클러치", user: 48, avg: 45 },
    ],
  },
};
